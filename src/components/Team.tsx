...
const teamList: TeamMemberProps[] = [
  {
    name: "Mario Andres Sierra Cano", rol: "Director", image: mario,
    social : { facebook: "", twitter: "1", instagram: "https://www.instagram.com/mario_andres_sierra/" }
  },
  {
    name: "Julian Andres Aguilar", rol: "Zootecnista", image: julian,
    social : { facebook: "", twitter: "2", instagram: "" }
  },
  {
    name: "Estefany Castaño Serna", rol: "Comunicadora y Fotografa", image: estefany, 
    social : { facebook: "", twitter: "3", instagram: "https://www.instagram.com/stefacs14/" }
  },
  {
    name: "Santiago Sierra Cano", rol: "Desarrollador de Sofware", image: santi,
    social : { facebook: "", twitter: "4", instagram: "https://www.instagram.com/santiagoscano/" }
  },
]
...
const Team = () => {
  return (
    <section id="team" className="bg-gray-1 dark:bg-dark-2 overflow-hidden pt-20 pb-12 lg:pt-[120px] lg:pb-[90px]">
      <div className="container mx-auto">
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          {teamList.map(({ name, rol, image, social:{facebook, twitter, instagram} }:TeamMemberProps, i) => (
            <div key={instagram} className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4"
              data-aos='fade-up' data-aos-duration='600' data-aos-delay={100*i}
            >
              <div className="group shadow-testimonial dark:shadow-none mb-8 rounded-xl bg-white dark:bg-dark px-5 pt-12 pb-10">
                <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                  <Image src={image} alt="team image" className="h-[120px] w-[120px] rounded-full" />
                  <span
                    className="bg-primary absolute bottom-0 left-0 -z-10 h-10 w-10 rounded-full opacity-0 transition-all group-hover:opacity-100">
                  </span>
                ...
                <div className="text-center">
                  ...
                  <div className="flex items-center gap-5 justify-center">
                    <a href={facebook} className="text-dark-6">
                    ...
                    <a href={twitter} className="text-dark-6">
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"
                        className="fill-current text-secondary hover:text-primary">
                        <path
                    ...
                    <a href={instagram} target='__blank' className="text-dark-6">
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"
                        className="fill-current text-secondary hover:text-primary">
                        <path
