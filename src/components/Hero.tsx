...
const Hero = () => {
  return (
    <main className='flex flex-col md:h-[135vh] h-[110vh] items-center justify-end relative'>
      <div className="w-full text-center">
        ...
        >
          ...
          <li>
            <a href="https://github.com/Santiscano/asoganan-landingpage" target="_blank"
