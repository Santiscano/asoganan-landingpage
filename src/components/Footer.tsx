...
import blogFooter1 from '@/assets/blog/blog-footer-01.jpg';
import blogFooter2 from '@/assets/blog/blog-footer-02.jpg';
    ...
    <footer className="wow fadeInUp relative z-10 bg-primary pt-20 lg:pt-[100px]" data-wow-delay=".15s">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-8 max-w-[270px] text-base text-gray-7 hover:text-white">
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <a href="#" className="mb-3 inline-block text-base text-gray-7 hover:text-white">
                    Inicio
                  </a>
                </li>
                <li>
              ...
              <div className="flex flex-col gap-8">
                <a href="blog-details.html" className="group flex items-center gap-[22px]">
                  <div className="overflow-hidden rounded">
                    <Image src={blogFooter1} alt="blog"/>
                  </div>
                ...
                <a href="blog-details.html" className="group flex items-center gap-[22px]">
                  <div className="overflow-hidden rounded">
                    <Image src={blogFooter2} alt="blog"/>
                  </div>
                  <span className="max-w-[180px] text-gray-7 text-base group-hover:text-white">
      ...
      <div>
        <span className="absolute left-0 top-0 z-[-1]">
          <Image src={shape1} alt="shaper footer" />
        </span>

        <span className="absolute bottom-0 right-0 z-[-1]">
          <Image src={shape3} alt="shaper footer" />
        </span>
